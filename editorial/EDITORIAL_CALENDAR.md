...
| 2 | 2026–27 property tax rates by city + ISD, re-verified against Tarrant & Parker appraisal districts | Data & Tools | Buyers, owners | "willow park property tax rate" | Aledo ISD $1.1775 (08-24) + City of Weatherford $0.392246 (09-08, flat) + WISD $0.9342 (09-14, −$0.10) all adopted & LIVE on the adoption watch 09-18; FWISD / WSISD / cities / counties pending | H | H | IN PROGRESS (roll full 2026–27 stacks into wfl-data.js tax table when majority adopt) |
...
| 15 | Comparison-page push — `/compare/willow-park-vs-hudson-oaks` (pos 2), `/compare/aledo-vs-weatherford` (pos 8.5): freshness pass + inbound links, no rewrites | Neighborhoods | Movers choosing between towns | already-ranking comparison queries | Have (data layer) | M | H | LIVE 2026-09-25 (labeled 2026–27 adoption updates added under both tables; inbound links already healthy; watch positions in next GSC export) |
...
| 16 | **Compare-cluster build-out** — the cluster Google ranks fastest (pos 2–16 on near-zero links). Shipped 09-25: `/compare/willow-park-vs-weatherford`, `/compare/hudson-oaks-vs-weatherford`. Next pairs as data allows: Benbrook vs Weatherford, Aledo vs Brock (towns), Walsh vs Willow Park | Neighborhoods | Movers choosing between towns | "willow park vs weatherford" + sibling pairs | Have (data layer + existing pages) | H | H | IN PROGRESS (2 LIVE 09-25) |
| 17 | **Weatherford ISD campus files** — Aledo ISD campus pages rank pos 7.6–9.3 with zero support; WISD (11 campuses, C→B in 2026) has no campus pages. Build from the TEA 2026 file via the schools generator | Schools | WISD families, movers | "[campus] weatherford tx rating" | Have (TEA 2026 spreadsheet on-site) | H | M | LIVE 2026-09-26 (all 10 campuses; deploy 6ab7b8a1) |
| 18 | **Town-footprint expansion: Brock, then Azle/Springtown** — Brock ISD compare already ranks pos 3 with no town page behind it; each new town adds guide + vibe + tax + compare query surface | Neighborhoods / Relocation | Movers priced out of Aledo; small-town buyers | "living in brock tx", "azle tx vs weatherford" | Sourceable (county records, TEA, published listings) | H | H | IDEA — Brock first |
| 19 | **West-side cost-of-living file** — anchor page for the relocation cluster; `/guides/moving-to-fort-worth-which-side` already at pos 10.5 | Relocation | Inbound movers | "cost of living fort worth suburbs" | Have (site's own verified rent/tax/insurance data) | H | M | IDEA |
| 20 | **Measurement upgrades (operator)** — fresh GSC export (owed since 09-22); consider GA4 (CSP already permits it); NETLIFY_AUTH_TOKEN secret for CI deploys | Infrastructure | — | — | Operator action | — | — | HOLD (operator) |
