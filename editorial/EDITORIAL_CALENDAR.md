...
> **⛔ ENGINE BLOCKER (opened 2026-08-16, still open as of 2026-09-03) — read before running a
...
> is a strict superset of this branch: 62 live sitemap URLs vs. 52 here, with 11 pages that exist
...
| 2026-09-03 | Commute-first neighborhood decision (gate → corridor → pocket → rent → 0630 test; no published commute times) | Neighborhoods | All inbound | "best neighborhoods oahu military" | Have (in-house POCKETS/base data + fixed corridor geography) | H | M | LIVE `/guides/commute-first.html` — shipped same-day (ported onto dd373n, see AUDIT_LOG 2026-09-03) | neighborhoods hub (reciprocal), guides hub |
| 2026-09-18 | Leasehold vs. fee simple on Oahu (land-tenure history, VA 14-year rule / Fannie 5-year rule, four lease numbers to pull) | Buying / VA | Inbound buyers, esp. condo-band | "leasehold vs fee simple hawaii condo" | Verified (38 CFR 36.4354, Fannie B2-3-03, HRS ch. 516 / Midkiff, Honolulu Ord. 05-001) | M | H | LIVE `/guides/leasehold-vs-fee-simple.html` — shipped same-day (ported onto dd373n, see AUDIT_LOG 2026-09-18) | buy hub (reciprocal), rent-vs-buy (reciprocal), guides hub |
...
| 3 | Fee simple vs leasehold on Oahu — why it matters more here | Buying | Inbound buyers | "leasehold vs fee simple hawaii condo" | SHIPPED 2026-09-18 → /guides/leasehold-vs-fee-simple.html | M | H | LIVE |
...
| 6 | The Oahu commute-first neighborhood decision (0630 drive test by gate) | Neighborhoods | All inbound | "best neighborhoods oahu military" | SHIPPED 2026-09-03 → /guides/commute-first.html | H | M | LIVE |
