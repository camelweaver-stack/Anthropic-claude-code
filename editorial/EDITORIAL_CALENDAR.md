...
| 17 | **Weatherford ISD campus files** — Aledo ISD campus pages rank pos 7.6–9.3 with zero support; WISD (11 campuses, C→B in 2026) has no campus pages. Build from the TEA 2026 file via the schools generator | Schools | WISD families, movers | "[campus] weatherford tx rating" | Have (TEA 2026 spreadsheet on-site) | H | M | NEXT |
