...
def gate_placeholders(docs):
    ...
    """
    # Denylist lives in ONE maintainable config, shared with the Netlify-build
    # validator (scripts/validate-production.js) so local gate and deploy gate
    # can never drift apart. Edit scripts/prohibited-content.json, not here.
    cfg_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                            "prohibited-content.json")
