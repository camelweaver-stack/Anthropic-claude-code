...
<section>
  ...
  <p><strong>Aledo ISD is in:</strong> on August 24, 2026 the board <a href="{SRC_ALEDO_2026}" rel="nofollow">adopted a 2026&ndash;27 rate of $1.1775</a> per $100 &mdash; down $0.0167 from $1.1942 and the district's eighth consecutive reduction. Once 2026 bills issue, the $140,000 exemption is worth about <strong>$1,649</strong> a year in Aledo ISD (65+/disabled at $200,000: about <strong>$2,355</strong>) &mdash; roughly $23 less than on the 2025 rate, because a lower rate makes every exemption dollar worth slightly less. <strong>Weatherford ISD followed on September 14:</strong> trustees <a href="{SRC_WISD_2026}" rel="nofollow">adopted a 2026&ndash;27 rate of $0.9342</a> per $100 (M&amp;O $0.7552 + I&amp;S $0.1790) &mdash; a full $0.10 below 2025's $1.0342, with the cut on the debt side (board action as reported by the <em>Weatherford Democrat</em>; the district's own tax pages still showed 2025&ndash;26 on our verify date). On the new rate, the $140,000 exemption is worth about <strong>$1,308</strong> a year in Weatherford ISD (65+/disabled at $200,000: about <strong>$1,868</strong>) &mdash; and the Aledo-vs-Weatherford school-tax gap widens to $0.2433 per $100. <strong>And the last two are in, per the Tarrant County Tax Office's official Truth-in-Taxation summary:</strong> <a href="https://www.tarrantcountytx.gov/en/tax/property-tax/truth-in-taxation-summary.html" rel="nofollow">White Settlement ISD adopted $1.1528</a> for tax year 2026 (down $0.0541 — the corridor's largest school-rate cut this cycle), making the $140,000 exemption worth about <strong>$1,614</strong> a year there (65+/disabled at $200,000: about <strong>$2,306</strong>); and <strong>Fort Worth ISD adopted $1.029099</strong>, essentially unchanged, worth about <strong>$1,441</strong> ($200,000: about <strong>$2,058</strong>). All four corridor districts have now adopted for 2026&ndash;27, every one flat or down; the main table above rolls to the 2026 rates in an upcoming refresh once the Parker-side figures are cross-confirmed on the county's official record.</p>
</section>
...
<section>
  ...
  <ul>
    ...
    <li>Aledo ISD &mdash; <a href="{SRC_ALEDO}" rel="nofollow">2025-26 adopted rate $1.1942</a> (seventh consecutive reduction); <a href="{SRC_ALEDO_2026}" rel="nofollow">2026-27 adopted rate $1.1775</a> (district news, 2026-08-24; eighth consecutive reduction).</li>
...
<section>
  ...
  <ul>
    ...
    <li>Aledo ISD &mdash; <a href="{SRC_ALEDO}" rel="nofollow">tasa adoptada 2025 $1.1942</a> / <a href="{SRC_ALEDO_2026}" rel="nofollow">tasa adoptada 2026&ndash;27 $1.1775</a> &middot; Weatherford ISD &mdash; <a href="{SRC_WISD}" rel="nofollow">tasa adoptada $1.0342</a> &middot; Fort Worth ISD &mdash; <a href="{SRC_FWISD}" rel="nofollow">tasa adoptada $1.0291</a> &middot; White Settlement ISD &mdash; $1.2069 seg&uacute;n la <a href="{SRC_TNT}" rel="nofollow">base oficial de Tarrant County</a>.</li>
  </ul>
